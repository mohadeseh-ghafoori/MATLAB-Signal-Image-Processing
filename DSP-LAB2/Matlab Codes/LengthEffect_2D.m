function [power,power2] = LengthEffect_2D(d)

    c = 330; %sound speed
    Fs = 48000; %sampling Frequency
    target_phi = [50 70 120]; % Source Number
    ...
    for phi=0:1:n_phi
        ...
        R_inv = inv(R);
        power(phi+1) = abs(1/sum(sum(R_inv))); % Power of formula P = 1/at*inv(R)*a by the sum of all element inv(R) because a is 1
